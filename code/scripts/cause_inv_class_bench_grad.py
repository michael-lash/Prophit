...
from inverse_classify_mod_grad import invBackPro
...
def main():
    ...
    logFile = projDir+"results/CAUSEbenchIC--probopt--grad--log.txt"
    ...
    resultsFileD2 = projDir+"results/CAUSEbenchICResults--probopt--grad.pickle" #Where the cross-validation results will be saved
